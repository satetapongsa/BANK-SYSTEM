...
export default function SettingsPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6 animate-fade-in">
      ...
      <Card className="relative overflow-hidden">
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h3 className="text-sm font-bold text-slate-800 mb-1">โหมดผู้ดูแลระบบ (Admin Access Control)</h3>
            <p className="text-xs font-semibold text-slate-550 mb-4">
            ...
            <label className="inline-flex items-center gap-3 cursor-pointer group">
              <div className="relative">
                ...
                />
                <div className="w-11 h-6 rounded-full bg-slate-100 border border-slate-200 peer-checked:bg-blue-600 transition-colors" />
              ...
              <span className="text-xs font-bold text-slate-550 group-hover:text-slate-750 transition-colors">
      ...
      {/* Danger Zone */}
      <Card className="border-rose-200/80 bg-rose-50/20 relative overflow-hidden">
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h3 className="text-sm font-bold text-rose-800 mb-1">พื้นที่ล้างข้อมูลระบบ (System Danger Zone)</h3>
            <p className="text-xs font-semibold text-slate-550 mb-4 leading-relaxed">
      ...
      <Card>
        <div className="flex items-start gap-4">
          <div className="w-10 h-10 bg-slate-50 rounded-xl flex items-center justify-center text-slate-500 border border-slate-200 flex-shrink-0">
            <Info size={20} />
          </div>
          <div className="space-y-2">
            <h3 className="text-sm font-bold text-slate-800 mb-1">เกี่ยวกับซอฟต์แวร์ (Software Specification)</h3>
            <div className="space-y-1.5 text-xs text-slate-550 font-semibold font-mono">
              <p>ชื่อระบบ: <span className="text-slate-700">WAVY BANK — Secure Digital Banking Portal</span></p>
              <p>เวอร์ชันผลิตภัณฑ์: <span className="text-slate-700">v1.2.0 (Tailwind Light Mode Optimized)</span></p>
              <p>ระบบการจัดเก็บ: <span className="text-blue-600 font-bold">Client-Side Secure Web Storage (AES-compatible)</span></p>
