    ...
    <div className="max-w-2xl mx-auto space-y-6 animate-fade-in">
      ...
      <Card className="relative overflow-hidden">
        ...
        <div className="flex items-start gap-4">
          <div className="w-10 h-10 bg-blue-950/40 rounded-xl flex items-center justify-center text-blue-400 border border-blue-900/40 flex-shrink-0">
            <Shield size={20} />
          </div>
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-1.5 text-xs text-slate-400 font-semibold font-mono">
              ...
              <p>เวอร์ชันผลิตภัณฑ์: <span className="text-slate-200">v1.2.0 (Tailwind Dark Mode Overhauled)</span></p>
              <p>ระบบการจัดเก็บ: <span className="text-blue-400 font-bold">Client-Side Secure Web Storage (AES-compatible)</span></p>
